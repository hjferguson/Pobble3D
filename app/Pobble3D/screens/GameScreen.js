...
export default function GameScreen() {
  ...
  const onContextCreate = async (gl) => {
    ...
    const positions = [
      ...
      // Bottom face
      { pos: [-1.5, -1.75, 1.25], rotation: [Math.PI / 2, 0, 0] }, { pos: [-0.5, -1.75, 1.25], rotation: [Math.PI / 2, 0, 0] },
      { pos: [0.5, -1.75, 1.25], rotation: [Math.PI / 2, 0, 0] }, { pos: [1.5, -1.75, 1.25], rotation: [Math.PI / 2, 0, 0] },
      { pos: [-1.5, -1.75, 0.25], rotation: [Math.PI / 2, 0, 0] }, { pos: [-0.5, -1.75, 0.25], rotation: [Math.PI / 2, 0, 0] },
      { pos: [0.5, -1.75, 0.25], rotation: [Math.PI / 2, 0, 0] }, { pos: [1.5, -1.75, 0.25], rotation: [Math.PI / 2, 0, 0] },
      { pos: [-1.5, -1.75, -0.75], rotation: [Math.PI / 2, 0, 0] }, { pos: [-0.5, -1.75, -0.75], rotation: [Math.PI / 2, 0, 0] },
      { pos: [0.5, -1.75, -0.75], rotation: [Math.PI / 2, 0, 0] }, { pos: [1.5, -1.75, -0.75], rotation: [Math.PI / 2, 0, 0] },
      { pos: [-1.5, -1.75, -1.75], rotation: [Math.PI / 2, 0, 0] }, { pos: [-0.5, -1.75, -1.75], rotation: [Math.PI / 2, 0, 0] },
      { pos: [0.5, -1.75, -1.75], rotation: [Math.PI / 2, 0, 0] }, { pos: [1.5, -1.75, -1.75], rotation: [Math.PI / 2, 0, 0] },
      // Left face
      ...
      { pos: [-1.75, 0.5, 1.25], rotation: [Math.PI / 2, -Math.PI / 2, Math.PI / 2] }, { pos: [-1.75, 0.5, 0.25], rotation: [Math.PI / 2, -Math.PI / 2, Math.PI / 2] },
      { pos: [-1.75, 0.5, -0.75], rotation: [Math.PI / 2, -Math.PI / 2, Math.PI / 2] }, { pos: [-1.75, 0.5, -1.75], rotation: [Math.PI / 2, -Math.PI / 2, Math.PI / 2] },
      { pos: [-1.75, -0.5, 1.25], rotation: [Math.PI / 2, -Math.PI / 2, Math.PI / 2] }, { pos: [-1.75, -0.5, 0.25], rotation: [Math.PI / 2, -Math.PI / 2, Math.PI / 2] },
      { pos: [-1.75, -0.5, -0.75], rotation: [Math.PI / 2, -Math.PI / 2, Math.PI / 2] }, { pos: [-1.75, -0.5, -1.75], rotation: [Math.PI / 2, -Math.PI / 2, Math.PI / 2] },
      { pos: [-1.75, -1.5, 1.25], rotation: [Math.PI / 2, -Math.PI / 2, Math.PI / 2] }, { pos: [-1.75, -1.5, 0.25], rotation: [Math.PI / 2, -Math.PI / 2, Math.PI / 2] },
      { pos: [-1.75, -1.5, -0.75], rotation: [Math.PI / 2, -Math.PI / 2, Math.PI / 2] }, { pos: [-1.75, -1.5, -1.75], rotation: [Math.PI / 2, -Math.PI / 2, Math.PI / 2] },
